"""
Django settings for acesso_41090 project.
...
ROOT_URLCONF = 'acesso_41090.urls'
...
WSGI_APPLICATION = 'acesso_41090.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "acesso_41090 API",
    "DESCRIPTION": "API documentation for acesso_41090 App",
    "VERSION": "v1",
}
